...
<div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('البريد الإكتروني') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="center" class="col-md-4 col-form-label text-md-end">{{ __('إسم المركز') }}</label>

                            <div class="col-md-6">
                                <select name="lock_center_id" class="form-select"  >
